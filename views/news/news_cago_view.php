<div class="content_link">
  <a href="/" title="Trang chủ">Trang chủ</a> &raquo; <a href="<?php echo base_url ?>tin-tuc.html" title="Tin tức">Tin tức</a> &raquo; <a href="javascript:void(0)" title=""><span class="sanpham"><?php echo $data['cago_detail']['cago_name']; ?>
</span></a>
</div>
    	...
    	<div id="content_left">
      	...
      	<div id="content_product">
				  ...
				  ?>
                    ...
                    <div class="clss"></div>
                    <?php } }else{echo "<div style='width: 696px;padding:0px 10px;'>Tin tức chưa được cập nhật !</div>";}?>
        </div>
