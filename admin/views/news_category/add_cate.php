				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<!-- <form action="<?php echo base_url; ?>admin/index.php?mod=menu&act=add" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data"> -->
                            		...
                            		<div class="form_items">
                                        ...
                                        <div class="form_items_right"><input name="menu" type="text" id="cago_title" size="35" /></div>
                                    </div>
                                    <!--div class="form_items">
                                    	<div class="form_items_left">Rewrite link</div>
                                        <div class="form_items_right"><input name="rewrite" type="text" id="rewrite" size="35" /></div>
                                    </div-->
                                    <!--div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        	<input type="submit" name="ok" id="add_cago" value="Add Menu" class="magin"/>
