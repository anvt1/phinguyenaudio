				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=recruitment&act=edit&rid=".$data['info']['rec_id'].""; ?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Tiêu đề tin</div>
                                        <div class="form_items_right"><input name="rec_title" type="text" id="news_title" size="35" value="<?php echo $data['info']['rec_title'];?>" /></div>
                                    </div>
                                    <!--div class="form_items">
                                    	<div class="form_items_left">Rewrite link</div>
                                        <div class="form_items_right"><input name="rec_rewrite" type="text" id="rec_rewrite" size="35" value="<?php echo $data['info']['rec_rewrite'];?>" /></div>
                                    </div-->
                                    <div class="form_items">
                                    	<div class="form_items_left">Tác giả</div>
                                        <div class="form_items_right"><input name="rec_author" type="text" id="rec_author" size="35" value="<?php echo $data['info']['rec_author'];?>"/></div>
                                    </div>
                                    <!--div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right"><textarea name="rec_info" cols="35" rows="3" id="rec_info"><?php echo $data['info']['rec_info'];?></textarea></div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">Nội dung chi tiết</div>
                                        <div class="form_items_right">
                                            <textarea name="rec_full" id="rec_full" cols="40" rows="4"><?php echo $data['info']['rec_full'];?></textarea> 
                                            <script type="text/javascript">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right"><img src="<?php echo base_url."uploads/recruitment/thumb/".$data['info']['rec_images'].""?>" width="150" height="130" /><input type="file" name="upload" id="upload" size="25" /></div>
                                    </div>
                                    <div class="form_items">
