					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url."admin/index.php?mod=news&act=add"; ?>" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
									  ...
									  <th width="166"><a href="#">Thuộc chuyên mục</a></th>
									  <th width="91"><a href="#">Actions</a></th>
									</tr>
                               <?php
							   	$stt = 0;
								if(isset($data['news']) && $data['news'] != NULL){
									foreach($data['news'] as $items){
										$stt++;
										echo "<tr>";	
										echo "<td>$stt</td>";
										echo "<td><a target='_blank' href='".base_url.'tin-tuc/'.$items['news_rewrite'].'/n'.$items['news_id'].'.html'."'>".$items['news_title']."</a></td>";
										echo "<td>".$items['news_author']."</td>";
										echo "<td>".$items['cago_name']."</td>";
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url."admin/index.php?mod=news&act=edit&nid=".$items['news_id']."' class='edit'>Edit</a></li>";
													echo "<li><a href='".base_url."admin/index.php?mod=news&act=del&nid=".$items['news_id']."' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
