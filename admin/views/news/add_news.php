				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=news&act=add"; ?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                                    ...
                                    <!--div class="form_items">
                                        ...
                                        <div class="form_items_right"><input name="news_rewrite" type="text" id="news_rewrite" size="35" /></div>
                                    </div-->
                                    <div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                            <textarea name="news_full" id="news_full" cols="40" rows="4"></textarea> 
                                            <script type="text/javascript">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        	<input type="submit" name="ok" value="Add News" class="magin" onclick="return checkFileUl();"/>
