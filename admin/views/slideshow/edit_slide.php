					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Sửa slideshow</h2>
							</div>
						</div>
				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=slideshow&act=edit&sid=".$data['info']['slide_id'].""; ?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Tiêu đề ảnh</div>
                                        <div class="form_items_right"><input name="slide_title" type="text" id="slide_title" size="35" value="<?php echo $data['info']['slide_title'];?>" /></div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">Trạng thái</div>
                                        <div class="form_items_right">
                                        	<select name="status">
                                            	<option value="1" <?php if($data['info']['slide_status'] == 1){ echo "selected = 'selected'"; }?>>-- Active -- </option>
      											<option value="0" <?php if($data['info']['slide_status'] == 0){ echo "selected = 'selected'"; }?>>-- Not Active -- </option>                                                
                                            </select>
                                        </div>
                                    </div>
                                    <!--div class="form_items">
                                    	<div class="form_items_left">Alt ảnh</div>
                                        <div class="form_items_right"><input name="slide_alt" type="text" id="slide_alt" size="35" value="<?php echo $data['info']['slide_alt'];?>"  /></div>
                                    </div-->
                                    <div class="form_items">
                                    	<div class="form_items_left">Hình ảnh</div>
                                        <div class="form_items_right"><img src="<?php echo base_url."public/images/slider/".$data['info']['slide_image'].""?>" width="200" height="100" /><input type="file" name="upload" id="upload" size="25" /></div>
                                    </div>
                                    <div class="form_items">
