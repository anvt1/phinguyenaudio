					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Hướng dẫn mua hàng</h2>
							</div>
						</div>
				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=guide&act=edit";?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Nội dung</div>
                                        <div class="form_items_right">
                                        <textarea name="guide_full" id="guide_full" cols="40" rows="4"><?php echo $data['info']['guide_full']; ?></textarea> 
                                            <script type="text/javascript">
												CKEDITOR.replace( 'guide_full' );
											</script> 
                                        <!--?php 
