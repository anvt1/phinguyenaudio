					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Dịch vụ</h2>
							</div>
						</div>
				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=services&act=edit";?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                                    <div class="form_items">
                                    	<div class="form_items_left">Mô tả</div>
                                        <div class="form_items_right">
                                        <textarea name="service_info" id="service_info" cols="40" rows="4"><?php echo $data['info']['service_info']; ?></textarea> 
                            		...
                            		<div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        <textarea name="service_full" id="service_full" cols="40" rows="4"><?php echo $data['info']['service_full']; ?></textarea> 
                                            <script type="text/javascript">
												CKEDITOR.replace( 'service_full' );
											</script> 
                                        <!--?php 
										$fck = new FCKeditor('intro_full');
										$fck->BasePath = sBASEPATH;
