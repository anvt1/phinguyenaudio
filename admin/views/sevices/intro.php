				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url."admin/index.php?mod=introduction&act=edit";?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Nội dung</div>
                                        <div class="form_items_right">
                                        <textarea name="intro_full" id="intro_full" cols="40" rows="4"><?php echo $data['info']['intro_full']; ?></textarea> 
                                            <script type="text/javascript">
												CKEDITOR.replace( 'intro_full' );
											</script> 
                                        <!--?php 
