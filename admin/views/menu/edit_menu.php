							...
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
                            		...
                            		<div class="form_items">
                                    	<div id="cate_id" style="display:none"><?php echo $data['info']['cate_id'] ;?></div>
                                    	<div class="form_items_left">Tiêu đề</div>
                                        <div class="form_items_right"><input name="menu" type="text" id="cate_title" size="35" value="<?php echo $data['info']['cate_name'] ;?>" /></div>
                                    </div>
                                    <!-- <div class="form_items">
                                    	<div class="form_items_left">Trạng thái</div>
                                        <div class="form_items_right">
                                        	<select name="status" id="cate_status">
                                            	<option value="1" <?php if($data['info']['cate_status'] == 1){ echo "selected = 'selected'"; }?>>-- Active -- </option>
      											<option value="0" <?php if($data['info']['cate_status'] == 0){ echo "selected = 'selected'"; }?>>-- Not Active -- </option>                                                
                                            </select>
                                        </div>
                                    </div> -->
                                    <!--div class="form_items">
                                    	<div class="form_items_left">Rewrite link</div>
                                        <div class="form_items_right"><input name="rewrite" type="text" id="rewrite" size="35" value="<?php echo $data['info']['cate_rewrite'] ;?>" /></div>
                                    </div>
                                    <!--div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        	<input type="submit" name="ok" id="edit_cate" value="Edit Menu" class="magin"/>
