					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url; ?>admin/index.php?mod=menu&act=add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                               ...
                               <?php
								if($data['list'] != NULL){
									...
									foreach($data['list'] as $item){
										$stt++;
										echo "<tr class='cate_id_".$item['cate_id']."'>";	
										echo "<td>".$stt."</td>";
										echo "<td>".$item['cate_name']."</td>";
										echo "<td>".$item['cate_rewrite']."</td>";
										//echo "<td>".$item['article_order']."</td>";
										//echo "<td>".$item['article_date']."</td>";
										if($item['cate_status'] == 1){
											 echo "<td><a rel='".$item['cate_id']."' href='javascript:void(0)' name='".$item['cate_status']."' class='status_active'>Active</a></td>";
										}else{
											echo "<td><a rel='".$item['cate_id']."' href='javascript:void(0)' name='".$item['cate_status']."' class='status_active'>Not active</a></td>";
										}
										//echo "<td><a class='status_' name='".$item['cate_id']."' href='javscript:void(0)'>Not active</a></td>";
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='index.php?mod=menu&act=edit&cid=".$item['cate_id']."' class='edit'>Edit</a></li>";
													echo "<li><a name='".$item['cate_id']."' href='javascript:void(0)' class='delete cate_id' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
